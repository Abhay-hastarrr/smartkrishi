    ...
    return (
        <div>
            ...
            <div className='w-full text-end mt-8'>
                <button onClick={() => navigate("/place-order",buyNow(id))} type='submit' className='bg-green-500 text-white px-16 py-3 text-sm rounded hover:scale-105 shadow-md hover:shadow-lg'>Submit</button>
            </div>
        </div>
    )
}
